...
This folder houses analysis code used to look for sueps.
...
git clone https://github.com/kdipetri/SUEP_coffea.git
cd SUEP_coffea 
./setup.sh
```
...
To make histograms, make sure you are in `SUEP_coffea`
```bash
python analyze.py -d < > -N <number of files>
```


### Running the Analysis - left over from t-channel
